...
class BasePathFinder: object
    ...
    findPath(fromNode, toNode)
    {
        ...
        /* 
         *   Add everything connected to the initial node.  This will
         *   visit each element and append anything connected to it that's
         *   not already in the working list.  We'll only add a given
         *   element once, so this loop is guaranteed to converge.  
         */
