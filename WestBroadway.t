...
+ skeletonKey: Key 'skeleton key' 'skeleton key' 
    "A key has been dropped on the ground in the haste of its owner\'s departure. The key is constructed of wrought iron. A generic, all purpose, skeleton key. The story told by it's appearance is outweighed by the vibe reverberating from the seemingly simple object."
;
